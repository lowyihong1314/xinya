...
from core.permissions import permission_descriptions as PERMISSION_DESCRIPTIONS
from core.permissions import permission_names as PERMISSION_CATALOG
...
# 同时把 app/blueprints.py 里的 ("app.permission_mgmt", "permission_bp", "/permission", "api")
