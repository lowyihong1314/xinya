...
export async function listBoards(version?: string) {
  ...
  const res = await apiFetch(`/board_router/boards${q}`, { credentials: "include" });
...
export async function createBoard(payload: { board_name: string; board_width?: number | null; board_height?: number | null; version?: string }) {
  const res = await apiFetch("/board_router/boards", {
    method: "POST",
    credentials: "include",
...
export async function updateBoard(boardId: number, payload: { board_name?: string; board_width?: number | null; board_height?: number | null }) {
  const res = await apiFetch(`/board_router/boards/${boardId}`, {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
...
export async function deleteBoard(boardId: number) {
  const res = await apiFetch(`/board_router/boards/${boardId}`, { method: "DELETE", credentials: "include" });
  return readJson<{ success?: boolean; all_board: Board[] }>(res);
}

export async function resetYearBarcodes(version: string) {
  const res = await apiFetch("/board_router/print-pdfs/reset", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
...
export async function attachPdfToBoard(payload: { board_id: number; pdf_id: number }) {
  const res = await apiFetch("/board_router/boards/entries", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
...
export async function reorderBoardEntry(payload: { board_id: number; pdf_id: number; location: number }) {
  const res = await apiFetch("/board_router/boards/entries/reorder", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
...
export async function deleteBoardEntry(boardDataId: number) {
  const res = await apiFetch(`/board_router/boards/entries/${boardDataId}`, { method: "DELETE", credentials: "include" });
...
export async function scanAttachToBoard(payload: { board_id: number; code: string }) {
  const res = await apiFetch("/board_router/boards/scan", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
...
export async function getPrintPdf(pdfId: number) {
  const res = await apiFetch(`/board_router/print-pdfs/${pdfId}`, { credentials: "include" });
...
export async function previewMergePrintPdfs(pdfIds: number[], targetId?: number | null) {
  const res = await apiFetch("/board_router/print-pdfs/merge/preview", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
...
export async function mergePrintPdfs(pdfIds: number[], targetId: number) {
  const res = await apiFetch("/board_router/print-pdfs/merge", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
...
export async function listUnattachedPdfs(version: string, page = 1, perPage = 12) {
  ...
  const res = await apiFetch(`/board_router/print-pdfs/unattached?${search.toString()}`, { credentials: "include" });
  return readJson<{
    success?: boolean;
    items: UnattachedPdf[];
...
export async function clearUnattachedPdfs(version: string) {
  const res = await apiFetch("/board_router/print-pdfs/unattached/clear", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ version }),
...
export async function quickSearchBoards(keyword: string, version?: string) {
  const res = await apiFetch("/board_router/orders/quick-search", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
...
export async function createBoardTerminalLink() {
  const res = await apiFetch("/board_router/terminal-link", { method: "POST", credentials: "include" });
...
export async function fetchTerminalBoards(token: string, version?: string) {
  ...
  const res = await apiFetch(`/board_router/terminal/boards?${search.toString()}`, { credentials: "include" });
...
export async function sendBoardHighlight(payload: BoardHighlightPayload) {
  const res = await apiFetch("/board_router/terminal/highlight", {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
