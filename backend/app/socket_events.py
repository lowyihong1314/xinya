...
from backend.app.quiz_game import socket_events as _quiz_game_socket_events  # noqa: E402,F401

# Register the 「别人眼中的我」 socket handlers on the same server.
from backend.app.mirror import socket_events as _mirror_socket_events  # noqa: E402,F401
