...
from backend.app.account.exceptions import NotFound, PermissionDenied, ValidationError
from backend.app.account.permissions import resolve_user_permissions, user_can_manage_claims, user_can_read_all_claims
from backend.core.config import env_value
from backend.app.account.serializers import serialize_request_data
