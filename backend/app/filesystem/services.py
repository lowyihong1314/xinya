...
from backend.app.filesystem.paths import STORAGE_ROOT, TRASH_ROOT
from backend.app.filesystem.serializers import serialize_file_item, serialize_view_history
...
from backend.models.user_data import Department, User
...
def get_file_detail(file_id, user_id):
    ...
    from backend.app.filesystem.serializers import serialize_file_detail
