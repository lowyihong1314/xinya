...
from backend.app.media.constants import IMAGE_EXTS, VIDEO_EXTS
from backend.core.urls import public_url
from backend.app.media.paths import event_photo_base_dir, event_photo_cache_dir, to_short_data_path
from backend.app.media.services import get_event_image_payload, resolve_media_path
...
def register_web_routes(app):
    ...
    @app.route("/template/council-sign-batch")
    def council_sign_batch_template():
        return render_template("form/council_sign_batch_public.html")
