...
from backend.app.media.utils import (
...
def download_files():
    try:
        ...
        for file in get_album_files(file_ids):
            if file:
                from backend.app.media.constants import IMAGE_EXTS
                from backend.app.media.paths import event_photo_base_dir, event_photo_cache_dir
