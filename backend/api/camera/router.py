...
from backend.core.auth import current_user, get_current_user_permissions, permission_required
...
#      ("backend.app.camera", "move_camera_bp", "/move_camera", "api")，并删掉 app/camera/。
#
